...
with nav_cols[2]:
    ...
    st.page_link("pages/12_📊_My_Holdings.py", label="📊 My Holdings", use_container_width=True)
    st.page_link("pages/11_🇮🇳_Kotak.py", label="🇮🇳 Kotak Neo", use_container_width=True)
